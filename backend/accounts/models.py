...
class UserSettings(models.Model):
    ...
    keyboard_settings = models.JSONField(default=default_keyboard_settings,
                                         blank=True)
...
class CustomUser(AbstractUser):
    ...
    avatar = models.ImageField(upload_to='avatars/',
                               max_length=255,
                               default='assets/avatars/ladybug.png')
...
class GameHistory(models.Model):
    ...
    opponent_user = models.ForeignKey(settings.AUTH_USER_MODEL,
...
class GameHostOptions(models.Model):
    ...
    def __str__(self):
        return (
            f"scoreToWin={self.scoreToWin}, difficulty={self.difficulty}, "
