    ...
    class TournamentGameManager {
      ...
      startGame() {
        ...
        if (player1IsBot && player2IsBot) {
          ...
          // Fonction pour générer un score aléatoire entre 0 et 5
          const getRandomScore = () => Math.floor(Math.random() * 6);
  
          // Générer des scores aléatoires pour la simulation
          const simulatedScore1 = getRandomScore();
          const simulatedScore2 = getRandomScore();
