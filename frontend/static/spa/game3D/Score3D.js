...
// import { longestRally, recordGame } from "./main.js";
...
export class Score3D {
  constructor(scene, camera, paddle1, paddle2, gamePlane) {
    ...
    // this.longestRally = 0; // Ajout de la propriété longestRally
  ...
  checkWinCondition() {
    if (
      ...
      if (scoreDifference >= this.POINT_DIFFERENCE_REQUIRED) {
        const winner =
          this.score.player1 > this.score.player2 ? "Blue" : "Orange";
        this.gameOver = true;
  ...
  // Ajouter un setter pour mettre à jour longestRally
  ...
  resetScore() {
    ...
    this.gameOver = false;
    this.longestRally = 0; // Réinitialisez ici
