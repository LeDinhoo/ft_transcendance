...
export class ReductShot {
  ...
  triggerAnimation(paddle, animationManager, targetPaddle, heightTarget) {
    ...
    const amplitude = 240; // Amplitude du mouvement sur l'axe Z

    // Calcul du décalage initial pour commencer au milieu
    // const phaseOffset = Math.asin(0) - this.cube.position.x * frequency; // z = 0 au départ
