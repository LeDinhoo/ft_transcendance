...
function initializePage() {
    ...
    if (!registerChoice || !signInChoice || !userForm || !submitBtn || !usernameInput || !confirmPasswordDiv) {
        console.error('Un ou plusieurs éléments de la page ne sont pas disponibles.');
        return;
    }
