			...
			chatMessages.addEventListener("click", async (e) => {
				...
				menu.addEventListener("click", async (e) => {
					...
					if (action === "send-invitation") {
						console.log("Sending invitation from chat to:", username, "with ID:", userId);
...
const GameInvitationManager = {
	...
	sendInvitation(username, userId) {
		...
		if (!window.wsManager?.chatSocket || window.wsManager.chatSocket.readyState !== WebSocket.OPEN) {
