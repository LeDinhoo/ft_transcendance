...
// Fonction pour créer les sphères de coin avec des pourcentages ajustables pour chaque coin
...
export function adjustCameraToRectangle(camera) {
  ...
  // Log pour confirmer le calcul de la distance
  // console.log("Calculated Camera Distance:", distance);
  // console.log("Aspect Ratio:", aspectRatio);
  // console.log("Distance for Height:", distanceHeight);
  // console.log("Distance for Width:", distanceWidth);
}
